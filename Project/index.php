    ...
    <nav class="navbar navbar-expand-lg bg-dark navbar-dark shadow-sm py-3 py-lg-0 px-3 px-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto mx-lg-auto py-0">
                ...
                <!-- <a href="Guest/GUESTSearchproduct.php" class="nav-item nav-link">Search</a> -->
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-12 col-md-6 text-center">
                    ...
                    <a href="Guest/login.php" class="btn btn-primary py-3 px-5">Order Now</a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="row gx-5">
                        ...
                        <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
                            ...
                            <div class="d-flex flex-column justify-content-start">
                                ...
                                <a class="text-secondary mb-2" href="term&condition.php"><i class="bi bi-arrow-right text-primary me-2"></i>Terms & Conditions</a>
